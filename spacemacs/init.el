...
you should place your code here."
  ...
  (defun trigger-jenkins-build ()
    (interactive)
    (shell-command "/home/jonasws/TINE/Brukerskifte/trigger-jenkins.sh $(basename $(git rev-parse --show-toplevel))")
    )

  (defun open-in-blueocean ()
    (interactive)
    (shell-command "/home/jonasws/TINE/Brukerskifte/open-jenkins-pipeline.sh $(basename $(git rev-parse --show-toplevel))")
    )

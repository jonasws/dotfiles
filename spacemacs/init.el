...
you should place your code here."
  ...
  (spaceline-define-segment spotify
    ...
    (string-join (butlast (split-string (spotify-current) "/")) ":")
    :enabled t
    )

  (spaceline-spacemacs-theme 'spotify)
)

...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font `("Dank Mono"
                               :size ,(if (or is-on-windows is-on-mac) 14 20)
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
   ;; The leader key
